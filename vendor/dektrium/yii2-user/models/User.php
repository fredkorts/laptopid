...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            'username'          => \Yii::t('user', 'Kasutajanimi'),
            'email'             => \Yii::t('user', 'Email'),
            'registration_ip'   => \Yii::t('user', 'Registreerimise IP'),
            'unconfirmed_email' => \Yii::t('user', 'Uus email'),
            'password'          => \Yii::t('user', 'Salasõna'),
            'created_at'        => \Yii::t('user', 'Registreerimise aeg'),
            'confirmed_at'      => \Yii::t('user', 'Kinnitamise aeg'),
        ];
    }
